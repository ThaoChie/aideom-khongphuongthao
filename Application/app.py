...
st.markdown("""<style>
    ...
    .stButton > button:hover { background: #E9C3BB; color: #fff; border-color: transparent; }
    ...
    [data-testid="stMetricValue"] { color: var(--accent-color) !important; font-size: 2rem; font-weight: 800; }
