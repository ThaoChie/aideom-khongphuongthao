from .common import *
LESSON_ID='lesson09'; TITLE='Bài 9 - Mô phỏng lao động AI'; DESC='Tính NetJob, đào tạo lại và cảnh báo ngành bị thay thế.'
PARAMS=[
...
def metadata(): return {'id':LESSON_ID,'title':TITLE,'description':DESC,'params':PARAMS,'module':'M4'}
def run(params=None):
