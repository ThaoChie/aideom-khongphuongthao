from .common import *
LESSON_ID='lesson06'; TITLE='Bài 6 - TOPSIS xếp hạng vùng AI'; DESC='Chuẩn hóa vector, entropy weight và TOPSIS cho 6 vùng.'
PARAMS=[
...
def metadata(): return {'id':LESSON_ID,'title':TITLE,'description':DESC,'params':PARAMS,'module':'M2'}
def run(params=None):
